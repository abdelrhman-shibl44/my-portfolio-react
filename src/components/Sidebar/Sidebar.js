        ...
        <>
            <div className={`sidebar d-flex justify-content-center flex-column align-items-center ${showMenu ? "open" : "close"}`}>
                <div onClick={() => navigate("/")} className='logo d-flex flex-column justify-content-center align-items-center'>
                    <img style={{ mixBlendMode: "darken" }} src="images/logo.png" alt="Lion" width="100" height="100" onContextMenu={disableRightClick} />
                    <h1 className='d-flex aling-items-center'>
                        <span><img style={{ mixBlendMode: "darken", objectPosition: '0 -5px', textShadow: '0 0 20px red' }} src="images/logo.png" alt="Lion" width="40" height="40" onContextMenu={disableRightClick} />
                        </span>
                        bdo
                    </h1>
                </div>
